...
export default {
  ...
  props: {
    ...
    modelValue: { type: [Number, OdataNumber], default: null },
    /**
    ...
    /** Tipo de dato OdataNumber a usar. */
    odataType: {
      type: Object,
      default: null,
      validator: odataType => !odataType ||
        odataType.constructor === OdataNumber ||
        odataType.constructor instanceof OdataNumber
    }
  },
  emits: [
    /**
     * Se genera cuando el usuario realiza una alteración en el valor del campo.
     * @property {number, OdataNumber} modelValue Valor actual del campo.
     */
    'update:modelValue',
  ...
  computed: {
    rawValue () {
      return this.modelValue instanceof OdataNumber
...
<template>
  <fura-number-field
    ...
    :use-grouping="useGrouping || modelValue?.useGrouping || undefined"
    :minimum-integer-digits="minimumIntegerDigits || modelValue?.minimumIntegerDigits || undefined"
    :minimum-fraction-digits="minimumFractionDigits || modelValue?.fractionDigits || undefined"
    :maximum-fraction-digits="maximumFractionDigits || modelValue?.fractionDigits || undefined"
